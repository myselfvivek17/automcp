      ...
      <div className="max-w-3xl mx-auto">
          ...
          <div className="flex gap-3 flex-wrap">
            {Object.keys(PRESETS).map(preset => (
              <button
                ...
                className="px-4 py-2 text-sm border border-gray-200 rounded-lg hover:bg-blue-50 hover:border-blue-400 transition-colors font-medium"
              >
        ...
        <div className="space-y-4 mb-6">
          {AGENT_ORDER.map((name, idx) => {
            ...
            return (
              <div key={name} className="bg-white rounded-xl shadow-md p-5">
                <div className="flex items-start gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500 mt-0.5">{AGENT_DESCRIPTIONS[name]}</p>
                  </div>
                </div>
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div className="col-span-2">
                    <label className="block text-xs font-medium text-gray-600 mb-1">
                      API Key Override{' '}
                      <span className="text-gray-400 font-normal">(optional — falls back to global key)</span>
                    </label>
                    <input
                      type="password"
                      value={config.apiKey}
